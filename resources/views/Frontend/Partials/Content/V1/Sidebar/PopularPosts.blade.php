              ...
              <div class="post-list-small__img-holder">
                <div class="thumb-container thumb-100">
                  <a href="{{ route('front.detailPage' , ['slug' => $news->slug, 'id' => $news->id]) }}">
                    <img data-src="{{ (filter_var($news->media, FILTER_VALIDATE_URL)) ? $news->media : 'upload/'.$news->media }}" src="img/empty.png" alt="{{ $news->slug }}" class="post-list-small__img--rounded lazyload">
                  </a>
                </div>
              </div>
