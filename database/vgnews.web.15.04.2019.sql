...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2019 at 05:53 AM
...
--
-- Truncate table before insert `admin_config`
--
...
--
-- Truncate table before insert `admin_operation_log`
--
...
--
-- Truncate table before insert `admin_permissions`
--
...
--
-- Truncate table before insert `admin_roles`
--
...
--
-- Truncate table before insert `admin_role_menu`
--

TRUNCATE TABLE `admin_role_menu`;
--
...
--
-- Truncate table before insert `admin_role_permissions`
--
...
--
-- Truncate table before insert `admin_role_users`
--
...
--
-- Truncate table before insert `admin_user_permissions`
--

TRUNCATE TABLE `admin_user_permissions`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `category_post`
--
...
--
-- Truncate table before insert `category_translations`
--
...
DROP TABLE IF EXISTS `category_url_craw`;
CREATE TABLE IF NOT EXISTS `category_url_craw` (
  `category_id` int(11) NOT NULL,
  `url_craw_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Truncate table before insert `category_url_craw`
--

TRUNCATE TABLE `category_url_craw`;
--
...
CREATE TABLE IF NOT EXISTS `comment_translations` (
  ...
  `locale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `comment_translations_comment_id_locale_unique` (`comment_id`,`locale`),
  KEY `comment_translations_locale_index` (`locale`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Truncate table before insert `comment_translations`
--

TRUNCATE TABLE `comment_translations`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `history_parses`;
CREATE TABLE IF NOT EXISTS `history_parses` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Truncate table before insert `history_parses`
--

TRUNCATE TABLE `history_parses`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `html_dom_rules`;
CREATE TABLE IF NOT EXISTS `html_dom_rules` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Truncate table before insert `html_dom_rules`
--

TRUNCATE TABLE `html_dom_rules`;
--
...
--
-- Truncate table before insert `inboxes`
--

TRUNCATE TABLE `inboxes`;
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `infomations` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `infomations_user_id_foreign` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Truncate table before insert `infomations`
--

TRUNCATE TABLE `infomations`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `layouts`
--
...
DROP TABLE IF EXISTS `layout_translations`;
CREATE TABLE IF NOT EXISTS `layout_translations` (
  ...
  `locale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `layout_translations_layout_id_locale_unique` (`layout_id`,`locale`),
  KEY `layout_translations_locale_index` (`locale`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Truncate table before insert `layout_translations`
--

TRUNCATE TABLE `layout_translations`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `media_post`
--

TRUNCATE TABLE `media_post`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `media_translations`
--

TRUNCATE TABLE `media_translations`;
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `navigation_translations` (
  ...
  `locale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `navigation_translations_navigation_id_locale_unique` (`navigation_id`,`locale`),
  KEY `navigation_translations_locale_index` (`locale`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Truncate table before insert `navigation_translations`
--

TRUNCATE TABLE `navigation_translations`;
--
...
CREATE TABLE IF NOT EXISTS `post_translations` (
  ...
  `feature` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  ...
  KEY `title` (`title`,`slug`,`status`,`feature`,`editor_pick`,`recommended`,`newsflash`,`count_share`,`count_view`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Truncate table before insert `post_translations`
--
...
--
-- Truncate table before insert `reactions`
--
...
--
-- Truncate table before insert `tag_translations`
--

TRUNCATE TABLE `tag_translations`;
--
...
DROP TABLE IF EXISTS `url_craws`;
CREATE TABLE IF NOT EXISTS `url_craws` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Truncate table before insert `url_craws`
--

TRUNCATE TABLE `url_craws`;
--
...
--
-- Truncate table before insert `viewer_logs`
--

TRUNCATE TABLE `viewer_logs`;
--
