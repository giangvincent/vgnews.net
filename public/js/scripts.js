...
(function ($) {
  ...
  $.get("/get-paginate-posts?page=1", function (data) {
    console.log('load paginate-posts');
    $('#paginate-posts').html(data);
  });
})(jQuery);
...
function getData(page) {
  $.ajax({
    url: '/get-paginate-posts?page=' + page,
    type: "get",
    datatype: "html"
  }).done(function (data) {
    $("#paginate-posts").empty().html(data);
    location.hash = page;
